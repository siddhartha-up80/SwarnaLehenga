          ...
          <div className="mt-10 grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4 md:mt-10">
            <article className="relative flex flex-col overflow-hidden rounded-lg border">
              <div className="aspect-square overflow-hidden">
                <img
                  ...
                  src="https://source.unsplash.com/random/1080×1920/?saree=1"
                  alt=""
                />
              </div>
            ...
            <article className="relative flex flex-col overflow-hidden rounded-lg border">
              <div className="aspect-square overflow-hidden">
                <img
                  className="h-full w-full object-cover transition-all duration-300 group-hover:scale-125"
                  src="https://source.unsplash.com/random/1080×1920/?saree=2"
                  alt=""
                />
              </div>
              <div className="absolute top-0 m-2 rounded-full bg-white">
            ...
            <article className="relative flex flex-col overflow-hidden rounded-lg border">
              <div className="aspect-square overflow-hidden">
                <img
                  className="h-full w-full object-cover transition-all duration-300 group-hover:scale-125"
                  src="https://source.unsplash.com/random/1080×1920/?saree=3"
                  alt=""
                />
              </div>
            ...
            <article className="relative flex flex-col overflow-hidden rounded-lg border">
              <div className="aspect-square overflow-hidden">
                <img
                  className="h-full w-full object-cover transition-all duration-300 group-hover:scale-125"
                  src="https://source.unsplash.com/random/1080×1920/?saree=4"
                  alt=""
                />
              </div>
            ...
            <article className="relative flex flex-col overflow-hidden rounded-lg border">
              <div className="aspect-square overflow-hidden">
                <img
                  className="h-full w-full object-cover transition-all duration-300 group-hover:scale-125"
                  src="https://source.unsplash.com/random/1080×1920/?saree=5"
                  alt=""
                />
              </div>
            ...
            <article className="relative flex flex-col overflow-hidden rounded-lg border">
              <div className="aspect-square overflow-hidden">
                <img
                  className="h-full w-full object-cover transition-all duration-300 group-hover:scale-125"
                  src="https://source.unsplash.com/random/1080×1920/?saree=6"
                  alt=""
                />
              </div>
            ...
            <article className="relative flex flex-col overflow-hidden rounded-lg border">
              <div className="aspect-square overflow-hidden">
                <img
                  className="h-full w-full object-cover transition-all duration-300 group-hover:scale-125"
                  src="https://source.unsplash.com/random/1080×1920/?saree=7"
                />
              </div>
            ...
            <article className="relative flex flex-col overflow-hidden rounded-lg border">
              <div className="aspect-square overflow-hidden">
                <img
                  className="h-full w-full object-cover transition-all duration-300 group-hover:scale-125"
                  src="https://source.unsplash.com/random/1080×1920/?saree=8"
                  alt=""
                />
              </div>
              <div className="absolute top-0 m-2 rounded-full bg-white">
