            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  onClick={()=>{addtoCart(slug, 1, 499, "Red Velvet Saree", "XL", "Red")}}
                >
                  Add To Cart
                </button>
              ...
              <div className="flex justify-start items-center w-max mt-10">
                <input
                  type="search"
                  name="Search"
                  placeholder="Chech availability"
                  className="w-32 py-2 pl-4 text-sm rounded-md sm:w-auto focus:outline-none bg-gray-100 text-gray-800 focus:bg-gray-50"
                  onChange={onChangePin}
                />
                <button
                  onClick={checkPincode}
                  className="flex ml-auto text-white bg-rose-500 border-0 py-1.5 px-6 focus:outline-none hover:bg-rose-600 rounded"
                >
                  Check
                </button>
              </div>
